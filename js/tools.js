...
const TOOLS = [
  // ── Application Security ──────────────────────────────────────
  {
    ...
    tagline: "Multi-language SAST covering Java, PHP, Python, and MERN with 320+ rules, dependency CVE analysis, and dark-theme HTML reports",
    category: "appsec",
    tags: ["SAST", "Java", "PHP", "Python", "MERN", "OWASP Top 10", "CWE", "CVE"],
    stats: { rules: "320+", scanners: 4, cves: "90+" },
    version: "4.0.0",
    language: "Python",
    ...
    icon: "code",
    highlights: [
      "4 SAST scanners: Java (122 rules), PHP (42 rules), Python (48 rules), MERN (39 rules)",
  ...
  },
  {
    ...
    stats: { checks: "67+", pillars: 5, modules: 15 },
    version: "1.0.0",
    language: "Python",
  ...
  // ── Infrastructure Security ───────────────────────────────────
  {
    ...
    tagline: "Live FortiOS REST API security scanner with 196 rules across 15 categories and 20 CVE detections with firmware version matching",
    category: "infra",
    tags: ["FortiGate", "FortiOS", "NGFW", "REST API", "CVE", "VPN", "ZTNA"],
    stats: { rules: 196, categories: 15, cves: 20 },
    version: "3.0.0",
    language: "Python",
    ...
    icon: "firewall",
    highlights: [
      "15 categories: admin access (22), firewall policies (14), SSL VPN (14), IPsec VPN (12), security profiles (11), logging (16), HA (8), certificates (10), network hardening (16), FortiGuard updates (7), ZTNA/SASE (5), wireless (8), backup/DR (5), authentication (6), firmware CVEs (20)",
      "Live FortiOS REST API scanning (/api/v2/cmdb/...) with token-based auth",
      "20 known FortiOS CVEs with train-based firmware version range matching",
      "FortiOS 6.x and 7.x support, wireless security, LDAP/RADIUS/SAML authentication checks",
      "CIS Benchmarks alignment, FortiGuard best practices, IronSkillet hardening",
      "JSON + interactive HTML dark-theme reports, CI/CD exit codes"
    ]
  },
  {
    id: "cisco-scanner",
  ...
  },
  {
    ...
    stats: { checks: "150+", groups: 19, frameworks: 6 },
    version: "2.0.0",
    language: "Python",
  ...
  },
  {
    ...
    tagline: "CIS Benchmark hardening scripts for major Linux distributions with L1/L2 profiles and automated audit modes",
    category: "infra",
  ...
  },
  {
    ...
    stats: { protocols: "7+", vendors: "130+", scanners: 2 },
    version: "1.0.0",
    language: "Python",
  ...
  // ── Threat Detection & Response ───────────────────────────────
  {
    ...
    tagline: "170+ SPL detection rules for Splunk SIEM covering Windows AD, RHEL Linux, and Apache, with MITRE ATT&CK technique mapping",
    category: "threat",
    tags: ["SPL", "Splunk", "SIEM", "Active Directory", "MITRE ATT&CK", "RHEL", "Apache"],
    stats: { rules: "170+", platforms: 3, formats: "SPL" },
    version: "1.0.0",
    language: "YAML/SPL",
  ...
  // ── Red Teaming ─────────────────────────────────────────────
  {
    ...
    tagline: "MITRE ATT&CK-aligned red team scanner for Windows with 29 technique modules across 7 tactics, dual check/simulate modes, and ATT&CK Navigator export",
    category: "redteam",
    tags: ["Red Team", "MITRE ATT&CK", "Windows", "PowerShell", "WinRM", "Credential Access", "Privilege Escalation"],
    stats: { modules: 29, tactics: 7, tests: 85 },
    version: "1.0.0",
    language: "Python",
    ...
    icon: "target",
    highlights: [
      "29 technique modules across 7 MITRE ATT&CK tactics: Reconnaissance (1), Discovery (8), Credential Access (6), Privilege Escalation (4), Execution (3), Persistence (3), Defense Evasion (4)",
      "Dual-mode operation: passive check (read-only, safe for production) and active simulate (requires --simulate flag) with automatic cleanup",
      "Credential Access: LSASS PPL/Credential Guard, SAM/NTDS.dit extraction, Kerberoasting (SPN + RC4/DES), brute force policy, credentials in files (GPP cPassword, unattend.xml)",
      "Privilege Escalation: UAC bypass (7 registry checks), token manipulation (9 dangerous privileges), DLL search order + side-loading (unquoted paths, AppInit_DLLs, WDAC)",
      "Defense Evasion: Defender status/tamper protection/exclusions, event log tampering, process masquerading, log clearing detection (Event ID 1102/104)",
      "Session abstraction: Local (subprocess) + Remote WinRM (pypsrp). Targets: Windows 10, 11, Server 2019, Server 2022",
      "Scan profiles (quick/full/stealth), ATT&CK Navigator JSON layer export, HTML/JSON/CSV reports, evidence chain logging, 85 unit tests"
    ]
  },
  {
    id: "rhel-red-teaming",
